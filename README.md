...
This is based on [Arno Fiva's template](https://github.com/arnofiva/arcgis-core-template).
...
The `dist` folder then contains all the files for the web app which can either be copied to a web server or pushed to the `gh-pages` branch to be served at `https://your_github_user.github.io/arcgis-core-template`.
